...
@Override
public EmissionFactor createFactor(Long activityTypeId, Double factor, String unit) {
    ...
    emissionFactor.setFactorValue(factor);   // ✅ FIXED
    emissionFactor.setUnit(unit);             // ✅ REQUIRED
